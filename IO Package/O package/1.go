...
func main() {
	...
	n, err = io.WriteString(file, "Hello2")
	fmt.Println(n, err)
	...
	// here, current and end point to the end of the file because the last operation we did was reading last 5 bytes if the file.
